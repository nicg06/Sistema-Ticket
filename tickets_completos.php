...
$nomses='';
$tra=new trabajo();
$prt=$tra->traer_tickets_cerrados();
             ...
             <span class="tools pull-right">
              ...
              <tr class="gradeX odd">
                  ...
                  <td class="center hidden-phone  sorting_1"><?php
                   ...
                   <td class="">
                     <a href="#"><button type="button" class="btn btn-success btn-sm"><i class="fa fa-edit"></i><font><font class=""> Atender </font></font></button></a>
                     <a href="#"> <button type="button" class="btn btn-danger btn-sm" ><i class="fa fa-trash-o"></i><font><font class=""> Eliminar </font></font></button></a>
                   </td>
              </tr>
             <?php }
              ?>         
